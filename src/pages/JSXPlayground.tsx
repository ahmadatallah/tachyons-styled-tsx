      ...
      <main>
        <Section mx="auto" maxWidth="128rem">
          <Header py={6} px={[4, 5]} color="white" bg="purple">
            <H2 mt={0} mb={2} fontSize={[2, 2, 3]} textStyle="caps">
              Experiment with semantic markup + css-in-js in TypeScript
            </H2>
            <H1 mt={0} mb={4} fontSize={[3, 5, 8]}>
              The Playground
            </H1>
            <P fontSize={3}>
              If you've wanted to try out emotion, react, and styled-system this playground is for you. Find the code
              editor at the bottom of the page. This is not type-checked playground. We are just using inferred typed
              HTML elements that's compiled to Javascript. That's why you can use any html element, but to use
              styled-system styling props you must capitalize the elements e.g. div =&gt; Div. To try it with types, we
              added a live example in Code Sandbox.
            </P>
            <P fontSize={3}></P>
            <A
              href="#try"
              title="Open in codesanbox"
              bg="light-gray"
              color="purple"
              borderRadius={2}
              py={3}
            ...
            <A
              href="https://codesandbox.io/s/awesome-dirac-lvbvf?file=/src/pages/JSXPlayground.tsx:995-1084"
              title="Open in codesanbox"
              bg="light-gray"
              color="purple"
              borderRadius={2}
        ...
        <article>
          <LiveProvider
            ...
            code={`
  <Div>
    <Section id="try" display='flex' px={[4,5]} py={4} flexWrap='wrap' mx={-3}>
